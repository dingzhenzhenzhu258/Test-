...
{
    public sealed class ReadHoldingRegistersCommand : ModbusCommandBase<byte[]>
    {
        public ReadHoldingRegistersCommand(byte slaveId, ushort startAddress, ushort count)
            : base(slaveId, 0x03)
        {
